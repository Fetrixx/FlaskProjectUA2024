...
LOGIN_MESSAGE = ["Por favor inicie sesion para acceder a esta pagina ."] # "Please log in to access this page."
...
REFRESH_MESSAGE = ["Vuelve a autenticar para acceder a esta pagina"] # "Please reauthenticate to access this page."
